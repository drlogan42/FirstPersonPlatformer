...
{
    public float mouseSens = 100.0f;            //Mouse sensativity
    ...
    private void Update()
    {
        lookDirection = Look.action.ReadValue<Vector2>() * mouseSens * Time.deltaTime;        //lookDirection stores value of Vector2 which holds "horizontal" and "vertical" input (look) from "Look" within InputSystem_Actions
